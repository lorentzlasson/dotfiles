...
before creating the PR, re-read the repo's CLAUDE.md or AGENTS.md in full and check every file in the diff against its conventions. fix violations first, so the PR does not ship them.
